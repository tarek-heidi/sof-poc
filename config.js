window.APP_CONFIG = {
  ...
  scope: "launch patient/Patient.r patient/Encounter.r patient/DocumentReference.crus user/DocumentReference.crus user/Practitioner.crs openid profile fhirUser online_access",
